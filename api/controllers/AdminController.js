    ...
    try {
      ...
      if (req.body.email && req.body.password) {
          ...
          if (admin_details.is_active) {
            ...
            if (admin_details.is_whitelist_ip == true && check_whitelist_data.length > 0) {
              ...
              if (check_whitelist != undefined) {
                if (check_whitelist.days != 0) {
                  ...
                  if (current_datetime > check_whitelist.expire_time) {
                    return res
                      ...
                      .json({
                        "status": 401,
                        "error": sails.__("Time for whitelist has been expired.").message
                      });
                  }
                }
                ...
                return res
                  ...
                  .json({
                    "status": 401,
                    "error": sails.__("Your IP has not been whitelisted. Please whitelist your IP to continue.").message
                  });
              }
            }
            ...
            if (role.is_active == "false" | role.is_active == false) {
              res
                ...
                .json({
                  "status": 400,
                  "error": sails.__("Contact Admin for Role").message
                });
              return;
            }
              ...
              .comparePassword(query.password, admin_details, async function (err, valid) {
                if (err) {
                  return res
                    ...
                    .json({
                      "status": 403,
                      "error": sails.__("Invalid email or password").message
                    });
                }
            ...
            return res
              ...
              .json({
                "status": 400,
                "error": sails.__("Contact Admin").message
              });
          }
        } else {
          return res
        ...
        return res
          ...
          .json({
            "status": 400,
            "error": sails.__("Email or password is not sent").message
          });
      }
    } catch (error) {
      // console.log(error)
    ...
    try {
      if (!email || !current_password || !new_password || !confirm_password) {
        return res
          .status(401)
          .json({
            error: sails.__("Please provide email, new password, confirm password").message
          });
      }
      ...
      if (new_password !== confirm_password) {
        return res
          ...
          .json({
            "status": 401,
            error: sails.__("password must match").message
          });
      }
      ...
      if (current_password === new_password) {
        return res
          ...
          .json({
            "status": 401,
            error: sails.__("current new must not be same").message
          });
      }
      ...
      if (!user_details) {
        return res
          ...
          .json({
            "status": 401,
            error: sails.__("Email address not found").message
          });
      }
      ...
      if (!compareCurrent) {
        return res
          ...
          .json({
            "status": 401,
            error: sails.__("Current password mismatch").message
          });
      }
      ...
      if (adminUpdates) {
        ...
        return res
          .status(401)
          .json({
            error: sails.__("Something went wrong! Could not able to update the password").message
          });
      }
    } catch (error) {
      // console.log(error)
    ...
    try {
      ...
      if (!user_details) {
        return res
          ...
          .json({
            "status": 401,
            error: sails.__("This email id is not registered with us.").message
          });
      }
      ...
      if (user_details.is_verified == false || user_details.is_new_email_verified == false) {
        return res
          ...
          .json({
            "status": 401,
            error: sails.__("This email id is verified.").message
          });
      }
    ...
    try {
      ...
      if (!admin_details) {
        return res
          ...
          .json({
            status: '401',
            error: sails.__("Invalid email").message
          });
      }
    ...
    try {
      ...
      if (admin_details) {
        ...
        if (updateAdmin) {
          ...
          return res.json({
            "status": 400,
            "error": sails.__("Update password Error").message
          });
        }
      } else {
        return res
          ...
          .json({
            status: 400,
            "error": sails.__("Reset Password link has been expired.").message
          });
      }
    } catch (error) {
      // await logger.error(error.message)
      ...
      if (req.body.email && req.body.roles) {
        ...
        if (existedEmployee.length != 0) {
          return res
            ...
            .json({
              status: 401,
              "error": sails.__("email exits").message
            });
        }
        ...
        return res
          .status(400)
          .json({
            'error': sails.__("Email & roles is required.").message,
            'status': 400
          })
      }
    } catch (error) {
      ...
      if (req.body.id) {
        ...
        if (employee) {
          ...
          return res
            ...
            .json({
              status: 400,
              'error': sails.__("Employee not found").message
            })
        }
      } else {
        return res
          ...
          .json({
            status: 400,
            'error': sails.__("Employee id is not sent.").message
          })
      }
    } catch (error) {
      // await logger.error(error.message)
  ...
  getEmployeeDetails: async function (req, res) {
    ...
    try {
      if (emp_id) {
        ...
        return res.json({
          "status": 400,
          "error": sails.__("Employee id is required").message
        });
      }
    } catch (error) {
      // await logger.error(error.message)
    ...
    try {
      ...
      if (!user) {
        return res
          ...
          .json({
            "status": 401,
            "error": sails.__("Admin not found or it's not active").message
          });
      }
    ...
    try {
      ...
      if (user.is_twofactor == true) {
        return res
          ...
          .json({
            "status": 401,
            "error": sails.__("2 factor already enabled").message
          });
      }
    ...
    try {
      ...
      if (user.is_twofactor == false) {
        return res
          ...
          .json({
            "status": 401,
            "error": sails.__("2 factor already disabled").message
          });
      }
      await Admin
        .update({
      ...
      if (adminData != undefined) {
        ...
        if (requestData.days != '' && requestData.days != null) {
          if (requestData.days > 0) {
            ...
            return res.status(500).json({
              status: 500,
              "error": sails.__("Days greater 0").message,
        ...
        if (add_data) {
          return res.status(401).json({
            status: 500,
            "error": sails.__("IP in whitelist exists").message,
    ...
    try {
      if (!req.user.isAdmin) {
        return res.status(403).json({
          status: 403,
          error: sails.__('Unauthorized Access').message
        });
      }
      var requestData = req.body;
      var addValue = {}
    ...
    try {
      ...
      if (userDetail != undefined) {
        ...
        return res
          ...
          .json({
            status: 500,
            "error": sails.__("User Detail Not Found").message,
    ...
    try {
      ...
      if (!user) {
        res
          ...
          .json({
            "status": 401,
            "error": sails.__("User not found").message
          });
      }
    ...
    try {
      ...
      if (!get_data) {
        return res
          ...
          .json({
            "status": 500,
            "error": sails.__("No record found").message,
      ...
      if (get_data.status == "closed") {
        return res
          ...
          .json({
            "status": 500,
            "error": sails.__("Twofactor request closed").message,
      ...
      if (req.body.last_transaction_id) {
        ...
        if (check_exist_transaction > 0) {
          return res
            ...
            .json({
              status: 500,
              "error": sails.__("Batch is already generated with this transaction").message,
        ...
        return res
          ...
          .json({
            "status": 400,
            "error": sails.__("Enter last transaction id").message
          });
      }
    } catch (error) {
      console.log(error);
    ...
    try {
      ...
      if (batch_id == "" || options == "") {
        return res
          ...
          .json({
            "status": 400,
            "error": sails.__("Missing Parameters").message
          });
      }
      ...
      if (batchDetail == undefined) {
        return res
          ...
          .json({
            "status": 500,
            "error": sails.__("Batch not found").message,
      ...
      if (options.length > 0) {
        ...
        return res.status(200).json({
          "status": 400,
          "error": sails.__("option type required").message,
          "data": newarray
        })
      }
            ...
            try {
              if (uploadedDoc.length > 0) {
                ...
                return res
                  ...
                  .json({
                    status: 500,
                    "error": sails.__("File size should be greater than 0").message,
    ...
    try {
      ...
      if (!pdfObject) {
        return res
          ...
          .json({
            "status": 401,
            "error": sails.__('Invalid data provided').message
          });
      }
      req
        .file('pdf_file')
