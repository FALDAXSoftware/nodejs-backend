...
module.exports = {
    ...
    getSymbolInfo: function (req, res) {
        res.json({
            ...
            // "exchange-listed": "Faldax",
            // "exchange-traded": "Faldax",
            has_intraday: false,
            has_no_volume: false,
            minmov: 1,
            minmov2: 0,
    ...
    getHistoryData: async function (req, res) {
        try {
            ...
            let candleStickData = await sails.helpers.tradding.getCandleStickData(crypto, currency, resolutionInMinute, from, to).tolerate("serverError", () => {
            ...
            return res.status(200).json({ s: "error", "errmsg": sails.__("Something Wrong") });
        }
    }
