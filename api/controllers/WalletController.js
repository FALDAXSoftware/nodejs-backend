            ...
            if (coin) {
                ...
                if (wallet) {
                    if (wallet.placed_balance >= parseInt(amount)) {
                        ...
                        if (coin.type == 1) {
                            ...
                            bitgoWallet.send(params)
                                .then(async function (transaction) {
                                    ...
                                    await Wallet.update({ id: wallet.id }).set({
                        ...
                        return res.status(400).json({ status: 400, message: "Issuficient coin balance in wallet" });
                ...
                return res.status(400).json({ status: 400, message: "Coin or token not available" });
