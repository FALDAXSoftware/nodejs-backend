    ...
    try {
      ...
      if (trade_type == 1) {
        ...
        tradeData = await sails.sendNativeQuery("Select jst_trade_history.id,jst_trade_history.user_id,jst_tr" +
          ...
          " users.email, jst_trade_history.created_at, jst_trade_history.execution_report,jst_trade_history.faldax_fees, jst_trade_history.network_fees ,jst_trade_history.order_id, jst_trade_history.buy_currency_amount, jst_trade_history.sell_currency_amount, jst_trade_history.faldax_fees_actual, jst_trade_history.difference_faldax_commission" + query, [])
