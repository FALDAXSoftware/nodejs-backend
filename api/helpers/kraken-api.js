module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    const secret = 'UrDm1iGcMS9fSkZjvJUy1u5ni0FgHWfj8ivqA4JdpMungTIoO91k1DEZP0LlxjcRHZaUZrTBksxS6IDK' +
        '4lSiCw=='; // API Private Key
    ...
    var data = await kraken.api('DepositMethods', {asset: 'ETH'})
